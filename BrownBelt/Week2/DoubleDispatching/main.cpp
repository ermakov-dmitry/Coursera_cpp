...
public:
    explicit Building(geo2d::Rectangle position) : building(position) {}
    bool CollideWith(const Unit& that) const override;
    bool CollideWith(const Building& that) const override;
    bool CollideWith(const Tower& that) const override;
    bool CollideWith(const Fence& that) const override;
...
private:
    geo2d::Rectangle building;
};

class Tower final : public Collider<Tower> {
public:
    explicit Tower(geo2d::Circle position) : tower(position) {}
    bool CollideWith(const Unit& that) const override;
    bool CollideWith(const Building& that) const override;
    bool CollideWith(const Tower& that) const override;
    bool CollideWith(const Fence& that) const override;
...
public:
    explicit Fence(geo2d::Segment position) : fence(position) {}
    bool CollideWith(const Unit& that) const override;
    bool CollideWith(const Building& that) const override;
    bool CollideWith(const Tower& that) const override;
    bool CollideWith(const Fence& that) const override;
...
geo2d::Point Unit::Get() const {
    return unit;
}

geo2d::Rectangle Building::Get() const {
    return building;
}

geo2d::Circle Tower::Get() const {
    return tower;
}

geo2d::Segment Fence::Get() const {
    return fence;
}
...
bool Building::CollideWith(const Unit &that) const {
    return geo2d::Collide(building, that.Get());
}
...
bool Tower::CollideWith(const Unit &that) const {
    return geo2d::Collide(tower, that.Get());
}
...
bool Fence::CollideWith(const Unit &that) const {
    return geo2d::Collide(fence, that.Get());
}
